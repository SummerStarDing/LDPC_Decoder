...
#
# Generated by export_simulation on Wed May 28 13:29:37 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './ram_r_50.sh' script.

./ram_r_50.sh -reset_run
...
./ram_r_50.sh -noclean_files

For more information on the script, please type './ram_r_50.sh -help'.
